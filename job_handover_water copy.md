...
# FTO01 
- 佈署專案步驟
  - 使用 AnyDesk 應用程式，打開程式後輸入 `1109937248/etic@13098982` 進入樹梅派電腦主機。
...
- 專案描述
  ...
  - 20260609 原工站station4 大小板綁定、station5 PCBA焊後站合併為【station4 PCBA綁定測試站】
...
# DTX01 ShopFloor_LocalController
- GitLab Project
  - http://192.168.1.37/dean.weng/fia01_localcontroller/-/tree/DTX01/DTX01_ShopFloor_LocalController
