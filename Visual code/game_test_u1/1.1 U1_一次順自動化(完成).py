...
#-------------------------1.登入模塊
    ...
    #<<<<<<<<<<<<<<<<<<<<<背景偵測popup，開始>>>>>>>>>>>>>>>>>>>>>>
        try:    
            ...
            try:
                div_element = WebDriverWait(driver, 5).until(
                    EC.presence_of_element_located((By.XPATH, '//div[contains(text(), "2001 Fundação da Empresa")]'))
                )
                print("3.2.1 Sobre Nós\033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"3.2.1 跳轉Sobre Nós失敗"+ "\033[0m")
            # 點擊頁面元素，使header黑色區塊消失
            ...
            #點擊Eventos
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH,'//*[contains(text(), "Eventos")]'))
            ).click()
            # 判斷是否引導至執照頁
            try:
                div_element = WebDriverWait(driver, 5).until(
                ...
                print("3.4.1 Eventos\033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"3.4.1 跳轉Eventos失敗"+ "\033[0m")
            
            # 點擊頁面返回建
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH,'//*[@alt="refresh"]'))
            ).click()
            # 點擊頁面返回建
            element = WebDriverWait(driver, 5).until(
                EC.element_to_be_clickable((By.XPATH,'//*[@class= "anticon anticon-left relative z-10"]'))
            ...
            try:
                ...
                print("3.4.2 Eventos返回鍵\033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"3.4.2 Eventos返回鍵失效"+ "\033[0m")
            #-------------------------3.5 Jogos
            #回到上頁
            driver.back()
            #點擊Jogos
            ...
            try:
                ...
                print("3.5 Jogos\033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"3.5 跳轉Jogos失敗"+ "\033[0m")
            #-------------------------4.Atividade模塊
            ...
            #點擊20%
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH,'//div[contains(text(), "depósito")]'))
            )
            driver.execute_script("arguments[0].click();", element)
            # 判斷是否引導至20%
            try:
            ...
            try:
                ...
                print("4.2.3 引導至儲值頁\033[32mOK\033[0m")
            except TimeoutException:
            ...
            driver.execute_script("arguments[0].click();", element)
            element = WebDriverWait(driver, 5).until(
            EC.presence_of_element_located((By.XPATH,'//div[contains(text(), "Fornecer à ")]'))
                    )
            action = ActionChains(driver)
            ...
            #判斷是否接上邀請
                ...
                print("\033[44m\033[97m" + "5.無接上寶箱" + "\033[0m")    
            except TimeoutException:
                try:
                #判斷是否接上寶箱
            ...
            try:
                ...
                print("8.1 重刷按鈕\033[32mOK\033[0m")
            except TimeoutException:
            ...
            try:
                ...
                print("8.2 引導至儲值頁\033[32mOK\033[0m")
            except TimeoutException:
        ...
        #-------------------------3.邀請banner
            ...
            #单击Todos關閉個人資訊頁
            element = WebDriverWait(driver, 5).until(
                        EC.presence_of_element_located((By.XPATH, '//span[text()="Todos"]')))
            action = ActionChains(driver)
            action.click(element).perform()
            #點擊Filter_slot
            try:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        driver.execute_script("arguments[0].click();", element)
                        print("9.1 Jo cgo_Others置頂\033[32mOK\033[0m")
            ...
            #點擊返回鍵
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH,'//*[@class= "anticon anticon-left relative z-10"]'))
            )
            driver.execute_script("arguments[0].click();", element)
            #判斷返回鍵功能
            try:
            ...
            #點擊Skrill
            element=WebDriverWait(driver,5).until(
                EC.presence_of_element_located((By.XPATH, "//img[contains(@alt,'footer3')]"))
                )
            driver.execute_script("arguments[0].click();", element)
            # 等待新窗口打开
            WebDriverWait(driver, 10).until(EC.number_of_windows_to_be(2))
            ...
            #點擊BeGambleAware
            element=WebDriverWait(driver,10).until(
                EC.presence_of_element_located((By.XPATH, "//img[contains(@alt,'footer5')]"))
                )
            driver.execute_script("arguments[0].click();", element)
            # 等待新窗口打开
            WebDriverWait(driver, 10).until(EC.number_of_windows_to_be(2))
            ...
            #點擊Interac
            element=WebDriverWait(driver,10).until(
                EC.presence_of_element_located((By.XPATH, "//img[contains(@alt,'footer6')]"))
                )
            driver.execute_script("arguments[0].click();", element)
            # 等待新窗口打开
            WebDriverWait(driver, 10).until(EC.number_of_windows_to_be(2))
            ...
            #點擊GamCare
            element=WebDriverWait(driver,10).until(
                EC.presence_of_element_located((By.XPATH, "//img[contains(@alt,'footer4')]"))
                )
            driver.execute_script("arguments[0].click();", element)
