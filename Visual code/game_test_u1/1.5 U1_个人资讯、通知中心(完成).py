...
#1.4 遊戲紀錄、更改個資頁---------------------------------------------------------
            ...
            try:
                element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[text()="Salvo com sucesso"]')))
            ...
            try:
                element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[text()="nome de usuário (4-16 letras e números)"]')))
                print("1.4.11 ID更改欄位3碼顯示錯誤訊息 \033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"1.4.11 ID更改欄位3碼未顯示錯誤訊息"+ "\033[0m")
            button = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located(((By.XPATH, '//*[contains(@class,"input-placeholder-color")]')))
            ).send_keys("1")
            try:
                ...
                EC.presence_of_element_located((By.XPATH, '//*[text()="nome de usuário (4-16 letras e números)"]')))
                print("\033[91m" +"1.4.12 ID更改欄位4碼顯示錯誤訊息"+ "\033[0m")
            except TimeoutException:
                print("1.4.12 ID更改欄位4碼未顯示錯誤訊息 \033[32mOK\033[0m")
            button = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[contains(@class,"ConfirmButton")]'))
            ).click()
            sleep(1)
            try:
                element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[text()="Salvo com sucesso"]')))
                print("1.4.13 更換ID4碼送出提示 \033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"1.4.13 更換ID4碼送出提示未顯示"+ "\033[0m")
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[@class="text-lg text-white flex gap-2"]')))
            element1=element.text
            if element1 == "1231":
                print("1.4.14 更換ID4碼成功 \033[32mOK\033[0m")
            else:    
                print("\033[91m" +"1.4.14 更換ID4碼失敗"+ "\033[0m")
            button = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located(((By.XPATH, '//*[text()="Editar"]')))
            ).click()
            button = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located(((By.XPATH, '//*[contains(@class,"input-placeholder-color")]')))
            ).send_keys("111111111111")
            try:
                element = WebDriverWait(driver, 1).until(
                EC.presence_of_element_located((By.XPATH, '//*[text()="nome de usuário (4-16 letras e números)"]')))
                print("\033[91m" +"1.4.15 ID更改欄位16碼顯示錯誤訊息"+ "\033[0m")
            except TimeoutException:
                print("1.4.15 ID更改欄位16碼無錯誤訊息 \033[32mOK\033[0m")
            button = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[contains(@class,"ConfirmButton")]'))
            ).click()
            sleep(1)
            try:
                element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[text()="Salvo com sucesso"]')))
                print("1.4.16 更換ID16碼送出提示 \033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"1.4.16 更換ID16碼送出提示未顯示"+ "\033[0m")
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[@class="text-lg text-white flex gap-2"]')))
            element1=element.text
            if element1 == "1231111111111111":
                print("1.4.17 更換ID16碼成功 \033[32mOK\033[0m")
            else:    
                print("\033[91m" +"1.4.17 更換ID16碼失敗"+ "\033[0m")
            button = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located(((By.XPATH, '//*[text()="Editar"]')))
            ).click()
            button = WebDriverWait(driver, 5).until(
            ...
            try:
                element = WebDriverWait(driver, 1).until(
                EC.presence_of_element_located((By.XPATH, '//*[text()="nome de usuário (4-16 letras e números)"]')))
                print("1.4.18 ID更改欄位17碼顯示錯誤訊息 \033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"1.4.18 ID更改欄位17碼未顯示錯誤訊息"+ "\033[0m")
            button = WebDriverWait(driver, 5).until(
            ...
            try:
                element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//*[text()="Número de telefone"]')))
                print("1.4.19 X icon功能 \033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"1.4.19 X icon功能失效"+ "\033[0m")
            element = WebDriverWait(driver, 5).until(
            ...
            try:
                ...
                print("1.4.20 隱私頁跳轉 \033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"1.4.20 隱私頁跳轉失效"+ "\033[0m")
            driver.back()
            button = WebDriverWait(driver, 5).until(
                        EC.presence_of_element_located((By.XPATH, '//span[@aria-label= "left"]'))
                    ).click()
            try:
                element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.XPATH, '//span[text()="Slots"]')))
                print("1.4.21 更改個資頁返回鍵 \033[32mOK\033[0m")
            except TimeoutException:
                print("\033[91m" +"1.4.21 更改個資頁返回鍵失效"+ "\033[0m")
#2. 通知---------------------------------------------------------
