...
#7.footer區塊 --------------------------------------          
            ...
            TestHelper1.Footer(driver, "7.1.1 filter_Slots", "Slots", "-Slots","Slots",537)
            TestHelper1.Footer(driver, "7.2.1 filter_Cards", "Cards", "-Cards","Slots",537)
            TestHelper1.Footer(driver, "7.3.1 filter_Fishing", "Fishing", "-Fishing","Slots",537)
            TestHelper1.Footer(driver, "7.4.1 filter_Arcades", "Arcades", "-Arcade","Slots",537)
            TestHelper1.Footer(driver, "7.5.1 filter_Bingo", "Bingo", "-Bingo","Slots",537)
            TestHelper1.Footer(driver, "7.6.1 filter_Tables", "Tables", "-Tables","Slots",537)
            TestHelper1.Footer(driver, "7.7.1 filter_Viver","Viver", "-Viver","Slots",537)
            TestHelper1.Footer(driver, "7.8.1 filter_Others", "Others", "-Others","Slots",537)
            TestHelper1.Footer(driver, "7.9.1 filter_Salão", "Salão", "Slots","Slots",537) 
