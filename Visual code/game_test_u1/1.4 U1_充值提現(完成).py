        ...
        try:
            ...
            try:
                div_element = WebDriverWait(driver, 5).until(
                    EC.presence_of_element_located((By.CSS_SELECTOR, '[placeholder*="Retirada mínima"]'))
                )
...
#1.2 金額欄位------------------------------------------
            ...
            try:
                div_element = WebDriverWait(driver, 5).until(
                    EC.presence_of_element_located((By.XPATH, '//*[contains(text(), "O valor que pode ")]'))
                )
...
#1.3 姓名欄位------------------------------------------
            ...
            action_chains.click(element).send_keys(Keys.BACKSPACE * 10).perform()
            element = WebDriverWait(driver, 5).until(
            EC.presence_of_element_located((By.CSS_SELECTOR, '[placeholder*="Retirada mínima"]'))
            ).send_keys('50')
            button = WebDriverWait(driver, 5).until(
...
#1.4 Código CPF空白------------------------------------------
            ...
            action_chains.click(element).send_keys(Keys.BACKSPACE * 15).perform()
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.CSS_SELECTOR, '[placeholder="Insira o nome do titular do cartão"]'))
            )
            action_chains.click(element).send_keys(Keys.BACKSPACE * 10).perform()
            ...
            try:
                div_element = WebDriverWait(driver, 5).until(
                    EC.presence_of_element_located((By.XPATH, '//*[contains(text(), "Insira seu CPF no formato correto")]'))
                )
...
#1.5 Tipo Pix選單-------------------------------------------
            ...
            click_option(driver, 'Telefone(+55)', 2)
            click_option(driver, 'CPF', 1)
#1.6 CPF--------------------
            element = WebDriverWait(driver, 5).until(
                EC.presence_of_element_located((By.CSS_SELECTOR, '[placeholder="Insira o seu código CPF"]'))
            )
...
#1.9 VIP引導鈕--------------------
            ...
            sleep(0.5)
#-------------------------2.充值
            print("\033[43m\033[30m" + "2.充值" + "\033[0m")
#-------------------------2.1充值提示  
